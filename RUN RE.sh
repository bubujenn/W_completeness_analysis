...
#!/bin/bash
#PBS -N RE_RUN_AAZW_v2
#PBS -l select=1:ncpus=20:mem=1024gb:scratch_ssd=500gb:singularity=True
#PBS -l walltime=144:00:00
#PBS -q large_mem@pbs-m1.metacentrum.cz
#PBS -M blanka.jendriskova0000@seznam.cz
#PBS -m bea
#PBS -o /storage/brno2/home/jendrb00/20_10_consultation/RE_final_inputs/RE_RUN_AAZW_v2_Output/stdout.txt
#PBS -e /storage/brno2/home/jendrb00/20_10_consultation/RE_final_inputs/RE_RUN_AAZW_v2_Output/stderr.txt

# ============================================================
# RepeatExplorer - AAZW vs PBrw (kompletnost W)
# Abraxas sylvata - Blanka Jendrisková
# Opravená verze 2
# ============================================================
...
INPUT_FILE="AAZW_vs_PBrw.fa"
INPUT_DIR="/storage/brno2/home/jendrb00/20_10_consultation/RE_final_inputs"
OUTPUT_DIR="${INPUT_DIR}/RE_RUN_AAZW_v2_Output"
REPO_IMAGE="library://repeatexplorer/default/repex_tarean:0.3.12-7a7dc9e"
